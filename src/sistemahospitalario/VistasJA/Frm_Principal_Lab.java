 ...
 * @author Jean Agreda
 */
public class Frm_Principal_Lab extends javax.swing.JFrame {

    /**
     * Creates new form Frm_Principal_Lab
     */
    public Frm_Principal_Lab() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton5.setText("Solicitud Pedido");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frm_Principal_Lab.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Frm_Principal_Lab().setVisible(true);
            }
        });
    }
